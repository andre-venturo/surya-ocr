...
```bash
# CPU
docker run --rm -v $(pwd)/data:/data -v surya-models:/root/.cache/datalab surya-ocr:cpu surya_ocr /data/input.pdf

# GPU
docker run --rm --gpus all -v $(pwd)/data:/data -v surya-models:/root/.cache/datalab surya-ocr:gpu surya_ocr /data/input.pdf
```
...
```bash
docker run --rm -v $(pwd)/data:/data -v surya-models:/root/.cache/datalab surya-ocr:cpu surya_detect /data/input.pdf
```
